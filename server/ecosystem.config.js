  ...
  apps: [
    {
      ...
      env: {
        ...
        DATABASE_URL: "mysql://root:Welcome123!@localhost:3306/ticketsystem",
        PORT: 4052,
        FILE_UPLOAD_PATH: "/var/www/ticketsystem/uploads",
        PASSWORD_RESET_URL:
          "https://ticketsystem.macsoftautomations.in/auth/reset-password",
