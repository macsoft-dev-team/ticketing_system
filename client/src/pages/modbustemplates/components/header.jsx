...
export default function Header({ onAddTemplate, onSearchChange, totalCount = 0 }) {
            ...
            <div className="flex justify-between items-center px-4 sm:px-0 py-3 sm:py-4">
                ...
                <div className="flex items-center space-x-2 sm:space-x-6">
                    ...
                    >
                        ...
                        <div>
                            <h1 className="text-sm sm:text-xl lg:text-2xl tracking-wide font-medium text-slate-700 uppercase">
