...
export default function TicketForm({
    open, handleClose, handleSubmit, currentData
}) {
    ...
    return (
        <Modal
            width="900px"
            title={currentData ? `Update Ticket: ${currentData.ticketCode}` : "Raise Ticket"}
            open={open}
        ...
        >
            ...
            >
                ...
                <Form.Item label="Picture" name="picture" valuePropName="file">
